...
#### 点乘
$\vec{a}\cdot\vec{b} = \left(\begin{matrix}u_1 \\ u_2 \\ ... \\ u_n\end{matrix}\right) \cdot \left(\begin{matrix}v_1 \\ v_2 \\ ... \\ v_n\end{matrix}\right) = sum\left(\begin{matrix}u_1 \cdot v_1 \\ u_2 \\ ... \\ u_n\end{matrix}\right) = \|\vec{a}\|\|\vec{b}\|\cdot\cos\theta$
