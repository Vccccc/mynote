...
### 2.3.9 Barriers
Our last synchronization mechanism is intended for groups of processes rather than two-process producer-consumer type situations. Some applications are divided into phases and have the rule that no process many proceed into the next phase until all processes are ready to proceed to the next phase